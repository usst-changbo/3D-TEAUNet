...
def get_num_layer_for_vit(var_name, num_max_layer, num_layers_enc=None):
    # Gets the number of layers of the VIT model based on the variable name and other parameters
...
class LayerDecayValueAssigner(object):
    # Different attenuation values are assigned to different layers of the vit model
...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None):
    # Groups of parameters are organized according to the parameters of the model and a list of parameter groups is returned
