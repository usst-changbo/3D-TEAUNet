...
# Sometimes have 3D data and a 3D network, but due to anisotropy (currently not supported in batchgenerators), can not be properly enhanced in 3D data, in this case,
# 3D data can be converted to 2D data and then converted to 3D data after enhancement.
...
if __name__ == "__main__":
    from dataset_loading import DataLoader3D, load_dataset
