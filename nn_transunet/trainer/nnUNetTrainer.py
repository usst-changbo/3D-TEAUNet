...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        # If only inference is run, self.dataset_directory is set (due to checkpoint loading) but does not matter.
    ...
    def initialize(self, training=True, force_load_plans=False):
        """
        For predictions of test cases, simply set training=False, which prevents loading the training data and initializing the training batch generator
        :param training:
        :return:
        """
    ...
    def initialize_network(self):
        """
        This is a specific U-Net and must be adapted to other network architectures
        :return:
        """
    ...
    def save_debug_information(self):
        # Save debugging information for analysis and review during training or inference
        dct = OrderedDict()
    ...
    def load_plans_file(self):
        """
        The plan file is generated through experiment planning
        :return:
        """
    ...
    def run_online_evaluation(self, output, target):
        '''It is used to calculate and save the true positive, false positive, false negative and Dice coefficient of the model'''
        with torch.no_grad():
    ...
    def finish_online_evaluation(self):
        ...
        # Calculate the Dice coefficient for each category, save in the list and skip NaN values
